                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a href="reviewerDashboard.php"><i class="fa fa-edit"></i> Questionnaire </span></a>
                                </li>
                                <li><a href="response_overall_reviewer.php"><i class="fa fa-bar-chart-o"></i> Overall Response </span></a>
                                </li>
                            </ul>
                        </div>
                                        ...
                                        <div id="step-4" style="display: none;">
                                            ...
                                            <p> <strong> <h2> [A] How relevant is this technology to India? <h2> </strong> </p>
                                                ...
                                                <tr> <div class="radio">
                                                 ...
                                                 <p> <strong> <h2> [D] Indicate any positive or negative impact(s) that you foresee (Optional)  <h2> </strong> </p>
                                                <div style="position:relative; top:-95px;" class="col-md-12 col-sm-12 col-xs-12"> 
                                                <textarea  rows="4" cols="50" id="comment" class="form-control col-md-7 col-xs-12" style="border-style: solid; border-color:#808080" > </textarea>
                                                </div>
                                            </form>
                                        </div>
        ...
        $.ajax({
                ...
                success: function(output){
                    ...
                    <?php 
                            ...
                            $nowdate = (array) $date;
                            $dateTime1= strtotime($dbdate['date']);
                            $dateTime2= strtotime($nowdate['date']);
